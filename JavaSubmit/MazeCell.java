...
{
    private int status;     // 0 = never visited
    // 1 = on current path
    // 2 = on dead-end path
    private int setNumber;  // used when constructing maze

    private boolean leftHedge;
    private boolean rightHedge;
    private boolean topHedge;
    private boolean bottomHedge;
