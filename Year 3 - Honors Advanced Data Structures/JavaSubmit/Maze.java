...
// for extra credit
       //  JPanel mazeContainer = new JPanel(new GridLayout(1,2));
       //   controlPanel.add(mazeContainer);
		// make multiple views and add them to the mazeContainer
		// instead of adding the view to the content pane, add
		// the mazeContainer
